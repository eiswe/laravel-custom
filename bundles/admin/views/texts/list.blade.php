...
/* admin menu */
      ...
      echo Button::link( $url.'/admin/text/add', 'Create Text - Text' );
...
<?php
    ...
    echo Form::inline_open();
        echo Form::text('id', null, array('class' => 'input-small', 'placeholder' => 'ID of Text'));
        echo Form::submit('Delete Text!');
        echo Form::token();
    echo Form::close();   
