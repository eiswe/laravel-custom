...
@section('content')
  ...
  <div class="span10">
    ...
    <h1>Pictures Area</h1>
  	...
  	<?php
      echo Breadcrumb::create(array('Add' => $url.'/admin/picture/add', 'Edit' => $url.'/admin/picture/edit', 'List'));
    // print_r($pages);
  ...
  <script type="text/javascript">
    $(document).ready(function(){
        $('tr').click(function() {                                                // table row was clicked
            ...
            var url = baseUrl + '/admin/picture/edit/' + value;                                 // build new url: baseUrl/edit/id
