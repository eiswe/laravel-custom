...
@section('subnav')
  <?php
      ...
      $adminSite = array(    // Sites witch will available in Admin Menu
        array( 'Home',      'home',     $surl.'home' ),
        array( 'Profile',   'profile',  $surl.'profile/index' ),
        array( 'Page',      'page',     $surl.'page/list' ),
        array( 'Text',      'text',     $surl.'text/list' ),
        array( 'Bones',     'bone',     $surl.'bone/list' ),
        array( 'Pictures',  'picture',  $surl.'picture/list' ),
      );
