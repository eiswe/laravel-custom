...
class Generate_Task {
  ...
  public function controller($arguments) {
    ...
    // created earlier.
    $path = realpath(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'controllers' . DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . $filename;
...
class Create_" . $name . "s_Table{
        ...
        \n  public function up()
  {
    ...
    $mpath = realpath(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'migrations' . DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . date('Y_m_d_His') . "_" . $mfilename;
    ...
    $path = realpath(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'models' . DIRECTORY_SEPARATOR) . DIRECTORY_SEPARATOR . $filename;
