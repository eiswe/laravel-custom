...
class Photo_Controller extends Base_Controller
{
    public function action_upload()
    {
        ...
        if( $upload_success ) {
			...
			Session::flash('status_success', 'Successfully uploaded your new LimeBlack');
        } else {
            Session::flash('status_error', 'An error occurred while uploading your new LimeBlack - please try again.');
        }
